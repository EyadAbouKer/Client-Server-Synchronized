...
public class Client extends Thread { 
     ...
     */
     public void readTransactions()
     {
        ...
        try
        {
        	inputStream = new Scanner(new FileInputStream("C:\\Users\\Admin\\Desktop\\Concordia\\Winter2024\\COMP 346 Operating systems\\Assignments\\Assignment2\\COMP346_PA2-main\\src\\transaction2.txt"));
        }
...
//        }
        ...
        if (getClientOperation().equals("sending")) {
            ...
            long sendingDuration = sendClientEndTime - sendClientStartTime;
            System.out.println("\n terminating client sending thread - Running time " + sendingDuration*20 + " ms");
//            Network.disconnect(Network.getClientIP()); un comment if needed
            ...
            long sendClientEndTime =  System.currentTimeMillis();
            long receivingDuration = sendClientEndTime - sendClientStartTime;
            System.out.println("\n terminating client receiving thread - Running time " + receivingDuration*20 + " ms");
        } else {
            System.out.println("ERROR: Wrong client type of operation!");
            System.exit(1);
        }
        System.out.println("&&DONE Client " + getClientOperation());
    }
}
