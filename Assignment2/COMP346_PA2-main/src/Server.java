...
public class Server extends Thread {
    ...
    private final Object depositSim = new Object();
    private final Object withdrawSim = new Object();
    private final Object querySim = new Object();
     ...
     */  
     public void initializeAccounts()
     {
        ...
        try
        {
         inputStream = new Scanner(new FileInputStream("C:\\Users\\Admin\\Desktop\\Concordia\\Winter2024\\COMP 346 Operating systems\\Assignments\\Assignment2\\COMP346_PA2-main\\src\\account.txt"));
        }
...
//             System.out.println("i= "+i+"--> acc no: "+account[i].getAccountNumber()+"++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
              return -1;}
         else{
//             System.out.println("i= "+i+"--> acc no: "+account[i].getAccountNumber()+"++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
...
//        }
        ...
        long duration = serverEndTime - serverStartTime;

            System.out.println("Server IP: "+ Network.getServerIP()+ "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
        ...
        System.out.println("\n Terminating server thread - " + " Running time " + (duration*20 ) + " milliseconds");
