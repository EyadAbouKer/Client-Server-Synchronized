...
public class Network extends Thread {
    ...
    private static Semaphore outputBufferSemaphore;
    private static Semaphore outputBufferSemaphoreFull;
    private static Semaphore inBufferSemaphoreEmpty;
    private static Semaphore inBufferSemaphoreFull;
    private static Semaphore mutexOut;
    private static Semaphore mutexIn;/* Network status - active, inactive */
     ...
     Network( )
      { 
         ...
         networkStatus = "active";
          ...
          outputBufferSemaphore = new Semaphore(maxNbPackets);
          outputBufferSemaphoreFull = new Semaphore(0);
          inBufferSemaphoreEmpty = new Semaphore(maxNbPackets);
          inBufferSemaphoreFull = new Semaphore(0);
     ...
     */
        ...
        {
            try {
                inBufferSemaphoreEmpty.acquire();
                mutexIn.acquire();
...
//        			System.out.println("\n DEBUG : Network.send() - inComingBuffer status " + getInBufferStatus());
     ...
     */
        ...
        {
            try {
                outputBufferSemaphoreFull.acquire();
                mutexOut.acquire();
     ...
     */
         public static boolean transferOut(Transactions outPacket)
        {
            ...
            mutexOut.release();
            outputBufferSemaphoreFull.release();
             return true;
        }   
       ...
       public static boolean transferIn(Transactions inPacket)
        {
            ...
            mutexIn.release();
            inBufferSemaphoreEmpty.release();
             return true;
        }   
